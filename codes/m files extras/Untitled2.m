...
clear all
close all
name1=('smartBAL_Accel.csv')
name2=('smartBAL_Gyro.csv')
name3=('smartBAL_Mag.csv')
...
for i=1:length(R_L)
 ...
 GXN(i) = R_L1(i,1)/norm(R_L1res(i));
 GYN(i) = R_L1(i,2)/norm(R_L1res(i));
 GZN(i) = R_L1(i,3)/norm(R_L1res(i));
